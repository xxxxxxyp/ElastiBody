...
class TestRun12StatesJointInversionScript(unittest.TestCase):
    ...
    def test_joint_solver_configuration_is_present(self):
        ...
        self.assertIn("observed_nodes_list = []", self.source)
        ...
        self.assertIn("observed_nodes_list.append(observed_nodes)", self.source)
        self.assertIn("observed_nodes_list=observed_nodes_list", self.source)
